...
public class Customer {
	...
	private BigDecimal cust_mobile;
	private String cust_address;
	private String cust_gname;
	private Date cust_luudate;
	private Integer cust_luser;
	...
	public Customer(Integer cust_id, String cust_firstname, String cust_lastname, Date cust_dob, String cust_panno,
			BigDecimal cust_mobile, String cust_address, String cust_gname, Date cust_luudate, Integer cust_luser) {
	...
	public void setCust_dob(String cust_dob) {
		this.cust_dob = Date.valueOf(cust_dob);
	}
	...
	public BigDecimal getCust_mobile() {
		return cust_mobile;
	}

	public void setCust_mobile(BigDecimal cust_mobile) {
		this.cust_mobile = cust_mobile;
	}
	...
	public void setCust_luudate(String cust_luudate) {
		this.cust_luudate = Date.valueOf(cust_luudate);
	}

	public Integer getCust_luser() {
		return cust_luser;
	}
	...
	public String toString() {
		return "Customer [cust_id=" + cust_id + ", cust_firstname=" + cust_firstname + ", cust_lastname="
				...
				+ cust_mobile + ", cust_address=" + cust_address + ", cust_gname=" + cust_gname + ", cust_luudate="
				+ cust_luudate + ", cust_luser=" + cust_luser + "]";
	}
}
