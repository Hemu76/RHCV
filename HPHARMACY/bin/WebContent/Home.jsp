...
System.out.println(pr.get(0).getMedicine());
%>
<body>
...
<center>
	...
	<script>
		...
		function dooo(){
			...
			sessionStorage.setItem("mname",selll);
			flag=1;
		}
		var sno="";
		var mname="";
		...
		if(flag===1){
			...
			tdef1.textContent="<%=pr.get(0).getSerialNumber()%>";
			tdef2.textContent="<%=pr.get(0).getMedicine()%>";
			tdef3.textContent="<%=pr.get(0).getBatchNumber()%>";
			tdef4.textContent="<%=pr.get(0).getExpiryDate()%>";
			tdef5.textContent="";
			tdef6.textContent="<%=pr.get(0).getPrice()%>";
